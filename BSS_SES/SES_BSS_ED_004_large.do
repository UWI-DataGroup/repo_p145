...
log using "`logpath'/version01/3-output/BSS_SES/PCA_Results/VSM_large.log", name(VSM_large) replace
...
lassoselect id = 24		// Selecting model 31- Model with the lowest BIC
