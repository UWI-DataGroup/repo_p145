...
foreach b in 		per_f_non_black	per_m_non_black	per_t_non_black		///
					per_amentities_radio per_bathroom_0 per_bedrooms_less_2	///
					per_rooms_less_3 per_t_prof_n_techoccupation		///
					per_f_prof_techoccupation per_t_prof_occupation		///
					per_m_prof_occupation per_f_prof_occupation			///
					per_t_manage_occupation	per_m_manage_occupation		///
					per_f_manage_occupation per_crime_victim			///
					per_live_5_more per_t_unemployment					///
					t_income_median m_income_median f_income_median		///
					per_t_high_income per_m_high_income per_f_high_income	///
					per_t_income_0_49 per_m_income_0_49 per_f_income_0_49	///
					per_t_education_tertiary per_m_education_tertiary	///
					per_f_education_tertiary per_renting	///
					per_htenure_owned hsize_mean {
...
foreach c in 		per_f_non_black	per_m_non_black	per_t_non_black
	...
	gen ln_`c' = ln(`c')
	recode ln_`c' (.=0)
	histogram  ln_`c', normal name(ln_`c')
...
foreach d in 		per_amentities_radio per_htenure_owned {
	...
	gen sq_`d' = `d'^2
	histogram sq_`d', normal name(sq_`d')
...
foreach e in 		per_m_prof_occupation  per_m_prof_occupation
	...
	gen sqr_`e' = sqr(`e')
	histogram sqr_`e', normal name(sqr_`e')
